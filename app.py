...
st.set_page_config(page_title="NutriTracker")

st.header("🥦NutriTracker Assistant")
...
finally give suggestion which item should be removed and which items should be added it meal to make the
